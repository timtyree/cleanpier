...
public class piHole {
	//cant use main here, find alternative
	 public static void piHole(String []args) throws Exception 
  {
  
	String POST_DATA = "topClients";
	
    Unirest.setTimeouts(0, 0);
    
    HttpResponse<String> response = Unirest.get("http://192.168.0.200/admin/api.php?" + POST_DATA)
...
public class main extends apiCall {
	...
	System.out.println("API" + apiCall.piHole(args);
