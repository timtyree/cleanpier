...
module.exports = {
    ...
    adminAuth: {
		...
		{
            username: "admin",
            password: "$2a$08$5Wh2k1HU4JCC.oV5OaA5D.YW8As9NEa62F9HX..68AqGz3tEA79mm",
            permissions: "*"
        },
		{
            username: "guest",
            password: "$2a$08$Fg/yRxn34x7xKu435SvdNeGbPtKiOe/Iy6QqRG2PeV.A.UvRaTIXe",
            permissions: "read"
        }
		]
    },
    ...
    //
    https: {
		key: fs.readFileSync('/etc/letsencrypt/live/cleanlegion.xyz/privkey.pem'),
		cert: fs.readFileSync('/etc/letsencrypt/live/cleanlegion.xyz/cert.pem')
	},
