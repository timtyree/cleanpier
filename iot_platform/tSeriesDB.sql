...
(1, 'test user 1', 'mZ84LPpcBl6PUqVRAiA1BBSTtzGgvdCzvP03io0BE0OYmqsDSDz9bCFNJEEptUjX', 'topic LIKE \'timestamp%\'', 'This is test user 1 who has access to only timestamp topic data and any other subtopics under that', '2020-05-05 13:09:28');
...
(1, 'timestamp rule', 0x31, 'timestamp%', '%', 'POST', 'https://www.cleanlegion.xyz:1880/pub/modifiedTime/rule-engine-working'),
(2, 'timestamp rule 2', 0x31, 'timestamp%', '%', 'POST', 'https://www.cleanlegion.xyz:1880/pub/modifiedTime/rule-engine-working-again'),
(3, 'again rule', 0x31, '%', '%again', 'POST', 'https://www.cleanlegion.xyz:1880/pub/modifiedTime/again found');
